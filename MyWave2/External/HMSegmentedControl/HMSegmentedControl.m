...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionIndicatorStyle == HMSelectionIndicatorResizesToStringWidth && stringWidth <= self.segmentWidth) {
        ...
        return CGRectMake(x, 20.0, stringWidth, self.selectionIndicatorHeight);
    } else {
        return CGRectMake(self.segmentWidth * self.selectedSegmentIndex, 20.0, self.segmentWidth, self.selectionIndicatorHeight);
    }
}
