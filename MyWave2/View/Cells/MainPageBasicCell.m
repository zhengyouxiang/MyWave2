...
@interface MainPageBasicCell ()

@end

@implementation MainPageBasicCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        postTimeLabel = [[[UILabel alloc] initWithFrame:CGRectMake(60, 35, 80, 20)] autorelease];
        ...
        sourceTipsLabel = [[[UILabel alloc] initWithFrame:CGRectMake(145, 35, 25, 20)] autorelease];
        sourceTipsLabel.text = @"来自";
        sourceTipsLabel.font = FontOFHelvetica11;
        [self.contentView addSubview:sourceTipsLabel];
        
        sourceLabel = [[[UILabel alloc] initWithFrame:CGRectMake(175, 35, 140, 20)] autorelease];
